...
변수 	 | 설명	예시
------------------------------------------------------------------------------------
$0	  | 스크립트 파일의 이름을 나타냅니다.	myscript.sh를 실행하면,
      |  $0는 myscript.sh가 됩니다.
------------------------------------------------------------------------------------
$1~$9	| 스크립트에 전달된 첫 번째부터 아홉 번째까지의 인자를 나타냅니다.
      |  ./script.sh arg1 arg2에서 $1은 arg1, $2는 arg2가 됩니다.
------------------------------------------------------------------------------------
${10} 이상	| 10번째 이후의 인자를 나타냅니다. 중괄호로 감싸야 합니다.
           | ${10}는 10번째 인자를 의미합니다.
------------------------------------------------------------------------------------
$#	| 스크립트에 전달된 인자의 총 개수를 나타냅니다.
    | ./script.sh a b c에서 $#는 3이 됩니다.
------------------------------------------------------------------------------------
$*	| 모든 인자를 하나의 문자열로 묶어서 반환합니다.
    | ./script.sh a b에서 "$*"는 "a b"가 됩니다.
------------------------------------------------------------------------------------
$@	| 모든 인자를 각각의 문자열 요소로 이루어진 배열로 반환합니다.
    | ./script.sh a b에서 "$@"는 "a" "b"가 됩니다.
------------------------------------------------------------------------------------
$$	| 현재 셸 또는 스크립트의 프로세스 ID(PID)를 나타냅니다.
------------------------------------------------------------------------------------
$?	| 마지막으로 실행된 명령어의 종료 상태(exit status)를 나타냅니다.
    | 0은 성공, 0이 아닌 값은 오류를 의미합니다.
------------------------------------------------------------------------------------
